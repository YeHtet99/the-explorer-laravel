...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm position-fixed top-0 w-100" style="z-index: 5;">
    <div class="container">
        <a href="{{ route('index') }}"><img src="{{ asset('images/logo.png') }}" alt="" style="height: 40px"></a>
                ...
                @auth()
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ auth()->user()->name }}
                            <img src="{{ asset(auth()->user()->photo) }}" alt="" class="user-img border-white rounded-circle shadow-sm">
                        </a>
